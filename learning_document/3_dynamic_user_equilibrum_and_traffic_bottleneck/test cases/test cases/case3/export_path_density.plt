...
set pm3d map
splot 'C:\GitHub\dtalite_software_release\learning_document\3_dynamic_user_equilibrum_and_traffic_bottleneck\test cases\test cases\case3\export_path_density.txt' matrix notitle
