...
#include "CSVParser.h"
#include "Geometry.h"
// CDlg_GISDataExport dialog

IMPLEMENT_DYNAMIC(CDlg_GISDataExport, CDialog)

CDlg_GISDataExport::CDlg_GISDataExport(CWnd* pParent /*=NULL*/)
: CDialog(CDlg_GISDataExport::IDD, pParent)
, m_GIS_ShapeFile(_T(""))
, m_CSV_File(_T(""))
...
CDlg_GISDataExport::~CDlg_GISDataExport()
{
}

void CDlg_GISDataExport::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlg_GISDataExport, CDialog)
	ON_BN_CLICKED(ID_IMPORT_GPS_SHAPE_FILE, &CDlg_GISDataExport::OnBnClickedImportGpsShapeFile)
	ON_BN_CLICKED(IDC_BUTTON_Find_Sensor_File, &CDlg_GISDataExport::OnBnClickedButtonFindSensorFile)
	ON_LBN_SELCHANGE(IDC_LIST1, &CDlg_GISDataExport::OnLbnSelchangeList1)
	ON_BN_CLICKED(ID_EXPORT_CSV_FILE, &CDlg_GISDataExport::OnBnClickedExportCsvFile)
	ON_BN_CLICKED(ID_EXPORT_GPS_SHAPE_FILE, &CDlg_GISDataExport::OnBnClickedExportGpsShapeFile)
	ON_BN_CLICKED(ID_EXPORT_KML_FILE, &CDlg_GISDataExport::OnBnClickedExportKmlFile)
	ON_BN_CLICKED(IDC_BUTTON_View_Sample_File, &CDlg_GISDataExport::OnBnClickedButtonViewSampleFile)
	ON_BN_CLICKED(IDC_BUTTON_Load_Sample_Shape_File, &CDlg_GISDataExport::OnBnClickedButtonLoadSampleShapeFile)
	ON_BN_CLICKED(IDC_BUTTON_Import_GIS_Shape_File, &CDlg_GISDataExport::OnBnClickedButtonImportGisShapeFile)
	ON_BN_CLICKED(IDC_BUTTON_Export_to_CSV_File, &CDlg_GISDataExport::OnBnClickedButtonExporttoCsvFile)
	ON_BN_CLICKED(IDC_BUTTON_View_EXPORTED_KML_FILE, &CDlg_GISDataExport::OnBnClickedButtonViewExportedKmlFile)
	ON_BN_CLICKED(IDC_BUTTON_Find_CSF_File, &CDlg_GISDataExport::OnBnClickedButtonFindCsfFile)
	ON_BN_CLICKED(IDOK, &CDlg_GISDataExport::OnBnClickedOk)
	ON_BN_CLICKED(ID_EXPORT_GIS_Shape_File, &CDlg_GISDataExport::OnBnClickedExportGisShapeFile)
	ON_BN_CLICKED(ID_IMPORT_GPS_OSM_POINT_SHAPE_FILE2, &CDlg_GISDataExport::OnBnClickedImportGpsOsmPointShapeFile2)
END_MESSAGE_MAP()


// CDlg_GISDataExport message handlers

void CDlg_GISDataExport::OnBnClickedImportGpsShapeFile()
{
	UpdateData(1);
...
void CDlg_GISDataExport::OnBnClickedButtonFindSensorFile()
{
...
void CDlg_GISDataExport::OnLbnSelchangeList1()
{
	// TODO: Add your control notification handler code here
}
void CDlg_GISDataExport::ExportDataToCSV(CString csv_file_name)
{
#ifndef _WIN64
...
void CDlg_GISDataExport::OnBnClickedExportCsvFile()
{
...
void CDlg_GISDataExport::OnBnClickedExportGpsShapeFile()
{
...
void CDlg_GISDataExport::ExportLinkLayerToShapeFile(CString file_name)
{
	//ExportToGISFile(file_name,  "ESRI Shapefile");

}
void CDlg_GISDataExport::OnBnClickedExportKmlFile()
{
	//	CString m_CSV_FileName;
...
void CDlg_GISDataExport::ExportToGISFile(LPCTSTR lpszCSVFileName,LPCTSTR lpszShapeFileName, CString GISTypeString )
{
...
void CDlg_GISDataExport::OnBnClickedButtonViewSampleFile()
{
...
void CDlg_GISDataExport::OnBnClickedButtonLoadSampleShapeFile()
{
	CMainFrame* pMainFrame = (CMainFrame*) AfxGetMainWnd();
...
void CDlg_GISDataExport::OnBnClickedButtonImportGisShapeFile()
{
	OnBnClickedImportGpsShapeFile();

}

void CDlg_GISDataExport::OnBnClickedButtonExporttoCsvFile()
{
	CMainFrame* pMainFrame = (CMainFrame*) AfxGetMainWnd();
...
void CDlg_GISDataExport::OnBnClickedButtonViewExportedKmlFile()
{
	CMainFrame* pMainFrame = (CMainFrame*) AfxGetMainWnd();
...
void CDlg_GISDataExport::OnBnClickedButtonFindCsfFile()
{
	CString str;
...
void CDlg_GISDataExport::OnBnClickedExportShapeFile()
{
}

void CDlg_GISDataExport::OnBnClickedOk()
{
	// TODO: Add your control notification handler code here
	OnOK();
}

void CDlg_GISDataExport::OnBnClickedExportGisShapeFile()
{
	m_MessageList.ResetContent ();
	CString m_CSV_FileName;
	CFileDialog dlg (FALSE, "*.shp", "*.shp",OFN_HIDEREADONLY | OFN_NOREADONLYRETURN | OFN_LONGNAMES,
...
BOOL CDlg_GISDataExport::OnInitDialog()
{
...
void CDlg_GISDataExport::SaveTNPProject()
{
	CString directory;
...
void CDlg_GISDataExport::OnBnClickedImportGpsOsmPointShapeFile2()
{
